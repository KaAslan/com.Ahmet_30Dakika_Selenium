...
public class ActionsClassUygulama_K {
@Test
public void test01(){
    //1. Launch browser
    ...
    //5. Click 'Signup' button -- > 4 ve 5 i birleştiriyoruz
    WebElement nameKutusu = driver.findElement(By.xpath("//input[@placeholder='Name']"));
actions.click(nameKutusu).sendKeys("Ahmet")
        .sendKeys(Keys.TAB)
        .sendKeys("a@bfcdlle.com") //her defasında değiştirmeli
        .sendKeys(Keys.TAB)
        .sendKeys(Keys.ENTER)
        .perform();
    ...
    //19 tane locate yapmaktan kurtulup .sendKeys(Keys.TAB) .sendKeys("xxx") ile  işi çözdük....
