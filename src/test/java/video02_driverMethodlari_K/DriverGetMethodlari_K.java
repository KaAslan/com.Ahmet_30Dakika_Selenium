package video02_driverMethodlari_K;

import io.github.bonigarcia.wdm.WebDriverManager;
import org.openqa.selenium.WebDriver;
import org.openqa.selenium.chrome.ChromeDriver;

public class DriverGetMethodlari_K {
    public static void main(String[] args) {
        ...
        System.out.println("sayfa title : " + driver.getTitle()); //Amazon.com. Spend less. Smile more.
             //sayfa title : Amazon.com. Spend less. Smile more.
       ...
       // 4- driver.getPageSource(); --> icinde oldugu sayfanin kaynak kodlarini döndürür
        ...
        //sayfanın kaynak kodlarını sayfadayken ctrl+u ile de görebiliriz
